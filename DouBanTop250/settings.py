...
#     #'DouBanTop250.middlewares.customProxy.horocnProxy':350,
#     #'DouBanTop250.middlewares.Doubantop250DownloaderMiddleware': 300,
    'DouBanTop250.middlewares.ProxyFromQT':100
 }
...
# each remote server
#AUTOTHROTTLE_TARGET_CONCURRENCY = 1.0p
...
# SETTING LOG
LOG_LEVEL = 'DEBUG'
LOG_FILE = 'log/AllDouBanMovies.log'
LOG_STDOUT = True
LOGSTATS_INTERVAL = 1
